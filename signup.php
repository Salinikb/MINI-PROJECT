...
<!-- php code -->
  ...
  $fullname  = $email = $phone = $password = $repassword = $gender = $nationality= "";
  global $validate;
  ...
  if(isset($_POST['submit'])){
    ...
    if($validate){
      signup($fullname,$email,$password,$phone,$repassword,$gender,$nationality,$type,$conn);
    }
  }
...
error_reporting(E_ALL);
  ...
  <div class="container">
    ...
    <form method="POST" autocomplete="off">
      ...
      <!--Confirm Password.-->
      <div class="form-floating mb-3">
        <input class="form-control" type="password" name="repassword" id="repassword" value="<?php echo $repassword ?>" placeholder="Re-Enter password">
