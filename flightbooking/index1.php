		...
		<div class="banner_w3lspvt">
			...
			<div id="homepage-slider" class="st-slider">
				...
				<div class="banner-text">
					<fieldset>
						<legend>
							<a href="index.html" class="logo">Willfly</a>
						</legend>
						<div class="banner-sub-txt">
							<h1 class="banner-txt">Book Your Flight With Us</h1>
							<p class="banner-txt1">An Investment In Travel Is An Investment in Youself.</p>
		...
		<div class="py-xl-5 py-lg-3">
			<div class="d-xl-flex about-grids">
				<div class="col-xl-4 about-left p-0">
					<img src="pictures/home3.jpg" alt="" class="img-fluid" />
				</div>
				<div class="col-xl-8 about-right border-bottom">
					<h3 class="mb-3">Never Stop Exploring</h3>
					<p class="mb-3">Airlines may be scheduled or charter operators.</p>
					<p>Airlines use aircraft to supply these services and may form partnerships or alliances with other airlines for codeshare agreements, in which they both offer and operate the same flight. Generally, airline companies are recognized with an air operating certificate or license issued by a governmental aviation body. 
						Airlines may be scheduled or charter operators</p>
					<a href="#" class="btn button-style-3">Learn More</a>
				</div>
			</div>
			<div class="d-xl-flex about-grids flex-row-reverse">
				<div class="col-xl-4 about-left p-0">
					<img src="pictures/home8.jpg" alt="" class="img-fluid" />
				</div>
				<div class="col-xl-8 about-right border-bottom">
					<h3 class="mb-3">Never Stop Exploring</h3>
					<p class="mb-3">An airline is a company that provides air transport services for traveling passengers and freight. 
</p>
					<p>Airlines use aircraft to supply these services and may form partnerships or alliances with other airlines for codeshare agreements, in which they both offer and operate the same flight. Generally, airline companies are recognized with an air operating certificate or license issued by a governmental aviation body. 
Airlines may be scheduled or charter operators.</p>
					<a href="#" class="btn button-style-3">Learn More</a>
			...
			<div class="d-xl-flex about-grids">
				...
				<div class="col-xl-8 about-right">
					<h3 class="mb-3">Never Stop Exploring</h3>
					<p class="mb-3">Airlines use aircraft to supply these services and may form partnerships or alliances with other airlines for codeshare agreements, in which they both offer and operate the same flight. Generally, airline companies are recognized with an air operating certificate or license issued by a governmental aviation body.
 Airlines may be scheduled or charter operators.</p>
					<p>Airlines use aircraft to supply these services and may form partnerships or alliances with other airlines for codeshare agreements, in which they both offer and operate the same flight. Generally, airline companies are recognized with an air operating certificate or license issued by a governmental aviation body. 
Airlines may be scheduled or charter operators.</p>
					<a href="#" class="btn button-style-3">Learn More</a>
 ...
 Airlines may be scheduled or charter operators.
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="row no-gutters">
				<div class="col-md-3 gal-img">
					<a href="#gal1"><img src="pictures/home11.jpg" alt="" class="img-fluid"></a>
				</div>
				<div class="col-md-3 gal-img">
					<a href="#gal5"><img src="pictures/home8.jpg" alt="" class="img-fluid"></a>
				</div>
				<div class="col-md-3 gal-img">
					<a href="#gal4"><img src="pictures/home4.jpg" alt="" class="img-fluid"></a>
				</div>
				<div class="col-md-3 gal-img">
					<a href="#gal3"><img src="pictures/home5.jpg" alt="" class="img-fluid"></a>
				</div>
			</div>
			<div class="row no-gutters">
				<div class="col-md-3 gal-img ml-auto">
					<a href="#gal6"><img src="pictures/home.jpg" alt="" class="img-fluid"></a>
				</div>
				<div class="col-md-3 gal-img mr-auto">
					<a href="#gal2"><img src="pictures/home3.jpg" alt="" class="img-fluid"></a>
				</div>
			</div>
			<!-- gallery popups -->
			<!-- popup-->
			...
			<div id="gal3" class="pop-overlay animate">
				<div class="popup">
					<img src="pictures/home8.jpg" alt="Popup Image" class="img-fluid" />
					<p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
						dolor.</p>
					<a class="close" href="#gallery">&times;</a>
				</div>
			...
			<div id="gal4" class="pop-overlay animate">
				<div class="popup">
					<img src="pictures/home11.jpg" alt="Popup Image" class="img-fluid" />
					<p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
						dolor.</p>
					<a class="close" href="#gallery">&times;</a>
				</div>
			...
			<div id="gal5" class="pop-overlay animate">
				<div class="popup">
					<img src="pictures/home10.jpg" alt="Popup Image" class="img-fluid" />
					<p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
						dolor.</p>
					<a class="close" href="#gallery">&times;</a>
				</div>
			...
			<div id="gal6" class="pop-overlay animate">
				<div class="popup">
					<img src="pictures/home5.jpg" alt="Popup Image" class="img-fluid" />
					<p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
						dolor.</p>
					<a class="close" href="#gallery">&times;</a>
				</div>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row text-center mt-4">
				<div class="col-lg-4 test-info">
					<p><span class="fa fa-quote-left mr-1"></span> Lorem Ipsum has been the industry's standard since
						the
	...
	<div class="text py-5 text-center">
		<div class="container py-xl-5 py-lg-3">
			<div class="row py-4">
				<div class="col-md-12">
					<h5 class="text-wh text-capitalize font-weight-bold let mb-4">life is short call in sick and book that last minute flight</h5>
